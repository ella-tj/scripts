...
[task_local]
#京东小魔方
23 2,20 * * * jd_xmf.js, tag=京东小魔方, img-url=, enabled=true
================Loon==============
[Script]
cron "23 2,20 * * *" script-path=jd_xmf.js, tag=京东小魔方
===============Surge=================
京东小魔方 = type=cron,cronexp="23 2,20 * * *",wake-system=1,timeout=3600,script-path=jd_xmf.js
============小火箭=========
京东小魔方 = type=cron,script-path=jd_xmf.js, cronexpr="23 2,20 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东小魔方');
